...
export default async function DashboardPage() {
  ...
  const { data: books } = await supabase.from('Books').select('*').order('id', { ascending: true })
  const { data: testimonials } = await supabase.from('Testimonials').select('*').order('id', { ascending: true })
